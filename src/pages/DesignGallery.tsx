...
import { Plus, FileImage, Trash2, ArrowLeft } from "lucide-react";
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <Card
              ...
              className="cursor-pointer hover:shadow-lg transition-all duration-300 border-2 border-dashed border-primary/50 hover:border-primary bg-card/50 backdrop-blur-sm"
            >
            ...
            {savedDesigns.map((design) => (
              <Card
                ...
                className="cursor-pointer hover:shadow-lg transition-all duration-300 overflow-hidden bg-card group relative"
              >
